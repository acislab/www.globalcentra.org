...
title: CENTRA 2026
permalink: /centra9/callforpresentations.html
...
<div class="container py-4">
    <div class="row align-items-center g-4">
        <div>
            <h1 class="display-5 fw-bold mt-2">Call for Presentations</h1>
            <div style="float:right; margin-left: 15px;">
                <div class="login-note" aria-live="polite">
                    ...
                    <i>Open Soon and <br>Sched.com login required.</i>
                </div>
                <div class="cta">
                    <a href="https://www.globalcentra.org/centra9/" target="_blank" class="btn btn-lg">
                        <!-- style="background-color:#53EFC8; color:#0049FF; font-weight:600; border-radius:0.5rem; width:200px; float: right;"> -->
    ...
    <div class="row g-4 mt-1">
        ...
        <div class="col-lg-6">
            <div class="card card-quiet h-100">
                ...
                <div class="card-body">
                    <ul class="list-dash">
                        <li><strong>New Project:</strong> proposals for new initiatives</li>
                        <li><strong>Project News:</strong> updates on ongoing collaborations</li>
            ...
            <div class="card card-quiet h-100">
                ...
                <div class="card-body">
                    <ul class="list-dash">
                        ...
                        <li>The extended abstract will be included in the <strong>Zenodo Global Central
                                Community</strong> collection.</li>
                        <li>
        ...
        <div class="col-lg-6">
            <div class="card card-quiet h-100">
                ...
                <div class="card-body">
                    <p>
                        Researchers, students, practitioners, and policymakers interested in advancing connected
                        intelligence and
                        sustainable technologies are strongly encouraged. Cross-sector and cross-country
                        collaborations are welcome.
                    </p>
                    <p class="mb-0">
                        Accepted submissions will be presented as <strong>10–15 minute talks or demos</strong>
                        during thematic sessions.
                        Presenters will have opportunities for discussion and collaboration with CENTRA partners.
                    </p>
                </div>
            </div>
        </div>
